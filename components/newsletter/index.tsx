    ...
    <div className="flex flex-col mx-auto w-[60%] justify-center items-center">
      ...
      <div className="flex gap-5">
        <Input
          type="email"
          size={70}
          className="bg-transparent placeholder:text-white text-xl rounded-sm p-5 py-6 focus-visible:ring-offset-0  focus-visible:ring-0 text-white border-white border w-full"
          placeholder="Email"
        />
